...
namespace ToolLibrary
{
    ...
    public interface iToolCollection
    {
        ...
        void add(Tool aTool, int quantity); //add a given tool to this tool collection

        void delete(Tool aTool, int quantity); //delete a given tool from this tool collection
